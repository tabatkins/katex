...
def supsub(group, options, prev=None):
...
def genfrac(group, options, prev):
...
def spacing(group, options, prev):
...
def overline(group, options, prev):
...
def underline(group, options, prev):
...
def styling(group, options, prev):
...
def leftright(group, options, prev):
