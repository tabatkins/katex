...
def defineSymbol(mode, font, group, replace, name):
    if mode not in modes:
        return
    modes[mode][name] = Symbol(font, group, replace)
...
# Latin-1 letters
for i in range(0x00C0, 0x00D6+1):
    ch = unichr(i)
    defineSymbol(text, main, textord, ch, ch)
}

for i in range(0x00D8, 0x00F6+1):
    ch = unichr(i)
    defineSymbol(text, main, textord, ch, ch)
}

for i in range(0x00F8, 0x00FF+1):
    ch = unichr(i)
    defineSymbol(text, main, textord, ch, ch)
}

# Cyrillic
for i in range(0x0410, 0x044F+1):
    ch = unichr(i)
    defineSymbol(text, main, textord, ch, ch)
}
